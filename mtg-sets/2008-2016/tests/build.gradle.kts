// Scenario tests for cards from sets released 2008–2016 — the test-side mirror of `:mtg-sets:2008-2016`.
//
...
//
// This depends on the `:mtg-sets` aggregator rather than `:mtg-sets:2008-2016`: ScenarioTestBase builds
