// Scenario tests for cards from sets released 2003–2007 — the test-side mirror of `:mtg-sets:2003-2007`.
//
...
//
// This depends on the `:mtg-sets` aggregator rather than `:mtg-sets:2003-2007`: ScenarioTestBase builds
