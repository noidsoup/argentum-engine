// Scenario tests for cards from sets released 2000–2002 — the test-side mirror of `:mtg-sets:2000-2002`.
//
...
//
// This depends on the `:mtg-sets` aggregator rather than `:mtg-sets:2000-2002`: ScenarioTestBase builds
