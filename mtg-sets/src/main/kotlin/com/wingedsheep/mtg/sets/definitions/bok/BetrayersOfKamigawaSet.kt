 ...
 *
 * The second set of the Kamigawa block, and the debut of ninjutsu. Scaffolded here as the canonical
 * home for cards whose earliest real printing is BOK (e.g. Skullsnatcher, reprinted in Planechase
 * 2012). Intentionally incomplete relative to the official set — only cards relocated here as their
