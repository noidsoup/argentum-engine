 ...
 *
 * Ninjutsu {3}{B}{B}
 * Whenever Ink-Eyes deals combat damage to a player, you may put target creature card from that
...
val InkEyesServantOfOni = card("Ink-Eyes, Servant of Oni") {
    ...
    power = 5
    toughness = 4
    oracleText = "Ninjutsu {3}{B}{B} ({3}{B}{B}, Return an unblocked attacker you control to hand: Put " +
    ...
    metadata {
        ...
        imageUri = "https://cards.scryfall.io/normal/front/3/8/386d391d-a3f8-49a4-802a-409944b2acf3.jpg?1783944195"
    }
}
