...
val CelestialAncient = card("Celestial Ancient") {
    ...
    metadata {
        ...
        artist = "Mark Tedin"
        flavorText =
            "\"We thought the clouds had moved from the night sky. Then the night sky moved, and the " +
                "horizon grew wings.\"\n—Josuri"
        imageUri = "https://cards.scryfall.io/normal/front/0/1/012fb3a6-99ff-4b5e-96e3-0a2eeca36bdb.jpg"
    }
}
