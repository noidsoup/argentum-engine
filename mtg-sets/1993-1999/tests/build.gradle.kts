// Scenario tests for cards from sets released 1993–1999 — the test-side mirror of `:mtg-sets:1993-1999`.
//
...
//
// This depends on the `:mtg-sets` aggregator rather than `:mtg-sets:1993-1999`: ScenarioTestBase builds
