// Scenario tests for cards from sets released in 2025 — the test-side mirror of `:mtg-sets:2025`.
//
...
//
// This depends on the `:mtg-sets` aggregator rather than `:mtg-sets:2025`: ScenarioTestBase builds
